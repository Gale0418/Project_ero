...
def main():
    ...
    output_dir = BASE_DIR / "outputs" / "all_models_skin_test"
    ...
    for idx, model_name in enumerate(model_names):
        ...
        if any(kw in model_name.lower() for kw in ["xl", "pony", "noobai", "illustrious", "animagine"]):
            target_vae = "sdxl_vae.safetensors"
        else:
            target_vae = "anime.vae.pt"
    ...
    print("\nAll models tested successfully! Check outputs in outputs/all_models_skin_test/")
